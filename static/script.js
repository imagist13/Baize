document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        heroTitle: { zh: "输入你想要的内容，白泽会为你创作。", en: "Enter what you want, Baize will create it for you." },
        startCreatingTitle: { zh: "开始创作", en: "Start Creating" },
        githubrepo: { zh: "Github 开源仓库", en: "Github Repository" },
        ...
        chatPlaceholder: {
            ...
            en: "AI results are random, you can enter modification suggestions here"
        },
        sendTitle: { zh: "发送", en: "Send" },
        agentThinking: { zh: "Baize Agent 正在进行思考与规划，请稍后。这可能需要数十秒至数分钟...", en: "Baize Agent is thinking and planning, please wait. This may take tens of seconds to minutes..." },
        generatingCode: { zh: "生成代码中...", en: "Generating code..." },
        codeComplete: { zh: "代码已完成", en: "Code completed" },
        ...
        featureComingSoon: { zh: "该功能正在开发中，将在不久的将来推出。\n 请关注我们的官方 GitHub 仓库以获取最新动态！", en: "This feature is under development and will be launched in the near future.\n Please follow our official GitHub repository for the latest updates!" },
        visitGitHub: { zh: "访问 GitHub", en: "Visit GitHub" },
        errorMessage: { zh: "抱歉，服务出现了一点问题。请稍后重试。", en: "Sorry, the service encountered a problem. Please try again later." },
        errorFetchFailed: {zh: "LLM 服务不可用，请稍后再试", en: "LLM service is unavailable, please try again later"},
        errorTooManyRequests: {zh: "今天已经使用太多，请明天再试", en: "Too many uses today, please try again tomorrow"},
        errorLLMParseError: {zh: "返回的动画代码解析失败，请调整提示词重新生成。", en: "Failed to parse the returned animation code, please adjust the prompt and regenerate."},
    };
    ...
    function init() {
        ...
        modalGitHubButton.addEventListener('click', () => {
            window.open('https://github.com/imagist13/Baize', '_blank');
            hideModal();
        });
